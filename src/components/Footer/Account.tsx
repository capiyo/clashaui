       ...
       <div className="bg-primary px-6 py-4">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* Education */}
            <div className="space-y-2">
              <label className="block text-sm font-medium text-primary">Education</label>
              {isEditing ? (
                <input
                  type="text"
            ...
            {isEditing ? (
              <div className="space-y-2">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-green-100 text-primary rounded-lg hover:bg-green-200"
                >
                  + Add Skill
                </button>
              </div>
              ...
              <div className="flex flex-wrap gap-2">
                {fruits.map((skill, index) => (
                  <span
                    key={index}
                    className="px-3 py-1 bg-green-100 text-primary rounded-full text-sm"
                  >
                    {skill}
                  </span>
                ))}
          ...
          {/* Description */}
          <div className="space-y-2">
            <label className="block text-sm font-medium text-primary">About Me</label>
            {isEditing ? (
              <textarea
                value={description}
            ...
            {isEditing ? (
              <>
                <button
                  ...
                  className="px-6 py-2 text-primary text-white rounded-lg hover:bg-green-700 transition-colors"
                >
                  Save Changes
                </button>
                <button
